...
var id = To((fe) => {
  ...
  function Aa(t) {
    const e = wa(t), n = {}, r = {}, s = /* @__PURE__ */ Symbol("break-walk"), o = /* @__PURE__ */ Symbol("skip-node");
    for (const i in e)
...
`, "");
  ...
  typeof window != "undefined" && (document.readyState !== "complete" ? window.addEventListener("load", () => {
    Nr();
  }) : Nr());
});
export default id();
