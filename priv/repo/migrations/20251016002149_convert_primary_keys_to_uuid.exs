defmodule ComnetWebsocket.Repo.Migrations.ConvertPrimaryKeysToUuid do
  use Ecto.Migration
  ...
  def up do
    ...
    alter table(:devices) do
      add :new_id, :binary_id, default: fragment("uuid_generate_v4()")
    end
  ...
  def down do
    # Convert back to integer primary keys
    ...
    execute "UPDATE devices SET new_id = nextval('devices_new_id_seq')"
    ...
    execute "UPDATE notifications SET new_id = nextval('notifications_new_id_seq')"
    ...
    execute "UPDATE device_activities SET new_id = nextval('device_activities_new_id_seq')"
    ...
    execute "UPDATE notification_trackings SET new_id = nextval('notification_trackings_new_id_seq')"
